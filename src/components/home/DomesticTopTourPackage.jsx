...
import { publicGetFiveDomesticItinerariesAsync, setParticularItineraryId } from "../../features/public/publicSlice";
...
const DomesticTopTourPackage = () => {
  ...
  useEffect(()=>{
    if(fiveDomesticItineraries?.length == 0){
      dispatch(publicGetFiveDomesticItinerariesAsync())
    }
    }, []);
  ...
  return (
    <>
    {
       ...
       <div className="mx-auto max-w-[1340px] px-4 sm:px-6 lg:px-8">
         ...
         {fiveDomesticItineraries?.map((itinerary, i) => (
