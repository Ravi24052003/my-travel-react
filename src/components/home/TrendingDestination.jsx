...
import { publicGetRandomItinerariesAsync, setParticularItineraryId } from "../../features/public/publicSlice";
...
const TrendingDestination = () => {
  ...
  const randomItineraries = useSelector(state => state.public.randomItineraries);
  ...
  useEffect(()=>{
    if(randomItineraries?.length == 0){
      dispatch(publicGetRandomItinerariesAsync())
    }
    }, []);
