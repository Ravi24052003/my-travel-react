...
export default function RegistrationPage({isRegistrationPageModalOpen, handleRegistrationPageCloseModal}) {
  ...
  return (
    <>
    {
      isRegistrationPageModalOpen && (

        <div className=" bg-black bg-opacity-50 max-h-[100vh] overflow-y-auto z-50 fixed top-0 left-0 w-full">
        ...
        <button
              className="absolute top-0 right-3 text-white hover:text-gray-200 text-7xl cursor-pointer z-[80] -m-2"
              onClick={handleRegistrationPageCloseModal}
            >
              &times;
            </button>
