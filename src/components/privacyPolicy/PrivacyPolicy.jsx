...
const PrivacyPolicy = () => {
  return (
    <div className="flex justify-center">
      <div className="max-w-7xl md:py-20 py-10 px-5">
        <h1 className="lg:text-6xl md:text-5xl  sm:text-4xl text-4xl  font-bold mb-8 text-center">Privacy Policy</h1>
        ...
        <h2 className="lg:text-3xl md:text-2lxl  sm:text-2xl text-2xl font-bold mb-4">Privacy Summary</h2>
        <p className="mb-8">
          Our website may contain links to other websites of interest. However, once you have used these links to leave
          our site, you should note that we do not have any control over that other website. Therefore, we cannot be
          responsible for the protection and privacy of any information which you provide whilst visiting such sites and
        ...
        <ol className=" mb-8 flex flex-col gap-5">
          <li className="mb-2">
            <span className='font-bold text-2xl'>1. What Personal Information we collect.</span>If you have previously agreed to us using your personal information for direct marketing purposes, you may
            change your mind at any time by writing to or emailing us at [email protected]  We will not sell, distribute, or lease your personal information to third parties unless we have your
            permission or are required by law to do so. We may use your personal information to send you promotional
          </li>
          <li className="mb-2">
          <span className='font-bold text-2xl'>2. What Personal Information we collect.</span>
          ...
          <li className="mb-2">
          <span className='font-bold text-2xl'>3. What Personal Information we collect.</span>
          ...
          <li className="mb-2">
          <span className='font-bold text-2xl'>4. What Personal Information we collect.</span>
            ...
            incorrect.  We will not sell, distribute, or lease your personal information to third parties unless we have your
            permission or are required by law to do so. We may use your personal information to send you promotional
          </li>
          <li className="mb-2">
          <span className='font-bold text-2xl'>5. What Personal Information we collect.</span>
            If you believe that any information we are holding on you is incorrect or incomplete, please write to or
            email us as soon as possible at the above address. We will promptly correct any information found to be
            incorrect.  We will not sell, distribute, or lease your personal information to third parties unless we have your
            permission or are required by law to do so. We may use your personal information to send you promotional
