    ...
    <div className="flex flex-col md:flex-row gap-6 max-w-7xl mx-auto p-4">
      ...
      <div className="w-full md:w-1/3 bg-white shadow-lg p-4 rounded-lg md:sticky md:top-20">
        ...
        <div className="mt-6 p-4 border rounded-md">
          <h3 className="text-lg font-semibold mb-2">Domestic Inquiry</h3>
          <form>
            <label className="block text-sm font-medium">Name</label>
            <input type="text" className="w-full p-2 border rounded-md mb-2" placeholder="Enter your name" />

            <label className="block text-sm font-medium">Email</label>
            <input type="email" className="w-full p-2 border rounded-md mb-2" placeholder="Enter your email" />
        ...
        {/* International Form */}
        <div className="mt-6 p-4 border rounded-md">
          <h3 className="text-lg font-semibold mb-2">International Inquiry</h3>
          <form>
            <label className="block text-sm font-medium">Name</label>
            <input type="text" className="w-full p-2 border rounded-md mb-2" placeholder="Enter your name" />
