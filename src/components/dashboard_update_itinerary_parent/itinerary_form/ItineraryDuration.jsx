...
import durationOptions from "../../dashboard_my_itineraries_builder_parent/durationOptions";
...
function ItineraryDuration() {
  ...
  console.log("ItineraryDuration.jsx itineraryForm duration optds", itineraryForm, durationOptions, "userItinearaies", userItineraries);
