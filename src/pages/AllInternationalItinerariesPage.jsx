...
import { publicGetAllInternationalItinerariesAsync, setParticularItineraryId } from "../features/public/publicSlice";
...
function AllInternationalItinerariesPage(){
    const dispatch = useDispatch();
  
    // Select the itineraries and loading state from redux store.
    const itineraries = useSelector(state => state.public.allInternationalItineraries);
    ...
    useEffect(() => {
      if (!itineraries || itineraries.length === 0) {
        dispatch(publicGetAllInternationalItinerariesAsync());
      }
    ...
    return (
      ...
      <section className="py-8">
        <div className="container mx-auto px-4">
          <h1 className="text-blue-900 text-5xl font-bold mb-4 text-center">Top International Packages</h1>
...
export default AllInternationalItinerariesPage;
