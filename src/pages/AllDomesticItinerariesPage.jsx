...
import { publicGetAllDomesticItinerariesAsync, setParticularItineraryId } from "../features/public/publicSlice";
...
function AllDomesticItinerariesPage(){
    const dispatch = useDispatch();
  
    // Select the itineraries and loading state from redux store.
    const itineraries = useSelector(state => state.public.allDomesticItineraries);
    ...
    useEffect(() => {
      if (!itineraries || itineraries.length === 0) {
        dispatch(publicGetAllDomesticItinerariesAsync());
      }
    ...
    return (
      ...
      <section className="py-8">
        <div className="container mx-auto px-4">
          <h1 className="text-blue-900 text-5xl font-bold mb-4 text-center">Top Domestic Packages</h1>
...
export default AllDomesticItinerariesPage;
